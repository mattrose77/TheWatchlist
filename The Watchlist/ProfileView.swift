...
struct ProfileView: View {
    ...
    @AppStorage("userName") private var userName = "Matt"
    @AppStorage("userHandle") private var userHandle = "mattrose"
    ...
    private var identityRow: some View {
        HStack(spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text("@\(userHandle) · Member since 2026")
                    .font(.system(size: 14))
    ...
    private var achievementsSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            HStack(spacing: 16) {
                ...
                achievementBadge(
                    icon: stats.hasGenreBuffAchievement.unlocked ? "film.fill" : "lock.fill",
    ...
    private var membershipCard: some View {
        HStack(spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text("Unlock unlimited adds + Top 5")
                    .font(.system(size: 14))
                    .foregroundColor(Color(hex: "0D1A22").opacity(0.6))
            }
